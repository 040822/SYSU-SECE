...
from ppo import PPO
model = PPO()
model.loadX(load_dir=os.path.dirname(os.path.abspath(__file__)),actorname="actor_5800",criticname="critic_5800")
...
def my_controller(obs_list,action_space_list,obs_space_list):
    ...
    action_ctrl_raw, action_prob= model.select_action(observation , False)
